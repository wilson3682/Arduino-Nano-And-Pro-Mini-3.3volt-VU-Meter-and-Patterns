...
#define brightControl A5     //A2 Arduino Pro Mini
int val;
...
void setup() {
  ...
  analogReference(EXTERNAL);            //Uncomment this line if using Arduino Pro Mini 3.3volts
...
SimplePatternList gPatterns = {ripple, ripple2, Twinkle, pattern2, pattern3, Balls, fire, rainbow_rotate, blur, juggle2};
